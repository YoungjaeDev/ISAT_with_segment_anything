...
ISAT focuses on image segmentation and aims to provide a smoother, more practical annotation workflow.

For the latest documentation, see [Documentation in English](https://isat-sam.readthedocs.io/en/latest/#) or [中文文档](https://isat-sam.readthedocs.io/zh-cn/latest/).

---

# News
- **As of version 1.5.2, ISAT supports visual prompts based on SAM3.**
...
- **As of version 1.5.0, ISAT supports SAM3 and text prompts.**
...
- **As of version 1.4.0, ISAT includes a plugin system.** You can extend ISAT with a relatively small amount of code.
...
- For other versions and release notes, see [releases](https://github.com/yatengLG/ISAT_with_segment_anything/releases).
