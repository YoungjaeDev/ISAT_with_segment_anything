...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/icons/ISAT_new_128.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.text_prompt_dock = QtWidgets.QDockWidget(MainWindow)
        self.text_prompt_dock.setObjectName("text_prompt_dock")
        self.dockWidgetContents_5 = QtWidgets.QWidget()
        self.dockWidgetContents_5.setObjectName("dockWidgetContents_5")
        self.text_prompt_dock.setWidget(self.dockWidgetContents_5)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.text_prompt_dock)
        self.visual_prompt_dock = QtWidgets.QDockWidget(MainWindow)
        self.visual_prompt_dock.setObjectName("visual_prompt_dock")
        self.dockWidgetContents_7 = QtWidgets.QWidget()
        self.dockWidgetContents_7.setObjectName("dockWidgetContents_7")
        self.visual_prompt_dock.setWidget(self.dockWidgetContents_7)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.visual_prompt_dock)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/icons/ISAT_new_32.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionRemote_SAM = QtWidgets.QAction(MainWindow)
        icon39 = QtGui.QIcon()
        ...
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.actionRemote_SAM.setFont(font)
        ...
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap(":/icon/icons/拼图_puzzle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPlugins.setIcon(icon40)
        ...
        self.actionExportOverlay = QtWidgets.QAction(MainWindow)
        icon42 = QtGui.QIcon()
        icon42.addPixmap(QtGui.QPixmap(":/icon/icons/叠加导出_overlay-export.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExportOverlay.setIcon(icon42)
        self.actionExportOverlay.setObjectName("actionExportOverlay")
        ...
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.actionExportOverlay)
        ...
        self.menuSAM_model.addAction(self.actionRemote_SAM)
        ...
        self.toolBar.addAction(self.actionExportOverlay)
        self.toolBar_2.addAction(self.actionModel_manage)
        self.toolBar_2.addAction(self.actionRemote_SAM)
        self.toolBar_2.addAction(self.actionPlugins)
        ...
        self.toolBar_2.addAction(self.actionDocs)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.text_prompt_dock.setWindowTitle(_translate("MainWindow", "Text prompt"))
        self.visual_prompt_dock.setWindowTitle(_translate("MainWindow", "Visual prompt"))
        ...
        self.actionCancel.setToolTip(_translate("MainWindow", "Cancel annotation"))
        self.actionCancel.setStatusTip(_translate("MainWindow", "Cancel annotation."))
        self.actionCancel.setShortcut(_translate("MainWindow", "Esc"))
        self.actionFinish.setText(_translate("MainWindow", "Finish"))
        self.actionFinish.setToolTip(_translate("MainWindow", "Finish annotation"))
        self.actionFinish.setStatusTip(_translate("MainWindow", "Finish annotation."))
        ...
        self.actionModel_manage.setText(_translate("MainWindow", "Model manager"))
        self.actionModel_manage.setIconText(_translate("MainWindow", "Model manager"))
        self.actionModel_manage.setToolTip(_translate("MainWindow", "Model manager"))
        self.actionModel_manage.setStatusTip(_translate("MainWindow", "Model manager."))
        self.actionModel_manage.setWhatsThis(_translate("MainWindow", "Model manager."))
        ...
        self.actionExportOverlay.setText(_translate("MainWindow", "Export overlay"))
        self.actionExportOverlay.setStatusTip(_translate("MainWindow", "Export current image with annotation overlay."))
