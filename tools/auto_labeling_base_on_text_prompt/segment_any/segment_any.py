...
class SegAny:
    ...
    def __init__(self, checkpoint: str, use_bfloat16: bool = True):
        ...
        if "mobile_sam" in checkpoint:
            # mobile sam
            from ISAT.segment_any.mobile_sam import (SamPredictor,
                                                     sam_model_registry)
            ...
            # edge_sam
            from ISAT.segment_any.edge_sam import (SamPredictor,
                                                   sam_model_registry)
            ...
            from .sam3.build_sam import Sam3Predictor as SamPredictor
            model_source = "sam3"
